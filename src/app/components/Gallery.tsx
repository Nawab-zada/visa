...
const Almarias= () => {
  return (
    <div className='flex flex-col lg:flex-row    '>
         <Image src={'/one.jpeg'} alt='logo' width={700} height={500} className=' sm:w-[660px] md:w-[1000px]'/>
     <div className=' w-full sm:w-[660px] md:w-[780px]  lg:w-[700px]  bg-blue-900   text-white'>
