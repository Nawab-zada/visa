...
const Almarias= () => {
  return (
    <div className='flex flex-col lg:flex-row    '>
         <Image src={'/one.jpeg'} alt='logo' width={700} height={500} className=' sm:w-[700px] md:w-[1200px]'/>
     <div className=' w-full sm:w-[600px] md:w-[1050px]  lg:w-[700px]  bg-blue-900   text-white'>
          
          <p className='p-6 md:w-[1050px] sm:w-[600px]  lg:w-full'>
