...
const Almaria= () => {
  return (
    <div className='flex flex-col lg:flex-row  '>
     <div className=' sm:w-[660px] lg:w-1/2 md:w-[800px]  bg-blue-900 mt-[30px]  text-white'>
    ...
    <div>
     ...
     <Image src={'/three.jpeg'} alt='logo' width={700} height={700} className='lg:w-1/2 mt-7 md:w-[800px] sm:w-[660px]'/>
    </div>
  )
}
