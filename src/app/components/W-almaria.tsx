...
const Almaria= () => {
  return (
    <div className='flex flex-col lg:flex-row  '>
     <div className=' sm:w-[460px] lg:w-[700px]  bg-blue-900 mt-[30px]  text-white'>
    ...
    <div>
     ...
     <Image src={'/three.jpeg'} alt='logo' width={700} height={700} className='mt-7 md:w-[1200px] sm:w-[460px]'/>
    </div>
  )
}
