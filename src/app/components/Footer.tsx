...
export default function Footer() {
  return (
    <footer className="w-full md:w-[1030px] lg:w-full  sm:w-[600px] sm:overflow-hidden ">
      ...
      <Link
        ...
        className="fixed bottom-4 left-4 bg-[#25D366] p-3 rounded-full hover:opacity-90 transition-opacity"
        target="_blank"
